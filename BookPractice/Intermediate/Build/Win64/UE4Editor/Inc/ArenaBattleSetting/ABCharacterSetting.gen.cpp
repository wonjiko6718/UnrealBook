...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UABCharacterSetting_Statics::NewProp_CharacterAssets = { "CharacterAssets", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UABCharacterSetting, CharacterAssets), METADATA_PARAMS(Z_Construct_UClass_UABCharacterSetting_Statics::NewProp_CharacterAssets_MetaData, ARRAY_COUNT(Z_Construct_UClass_UABCharacterSetting_Statics::NewProp_CharacterAssets_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UABCharacterSetting_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_UABCharacterSetting_Statics::PropPointers),
		0,
		0x001000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UABCharacterSetting_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UABCharacterSetting_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UABCharacterSetting, 2612346651);
